...
$(function() {
    ...
    var data = [{ data: d1, label: "Pressure", color: "#ef5c64" }];

    var markings = [
        { color: "#141921", yaxis: { from: 1 } },
        { color: "#141921", yaxis: { to: -1 } },
        { color: "#ef5c64", lineWidth: 1, xaxis: { from: 2, to: 2 } },
        { color: "#ef5c64", lineWidth: 1, xaxis: { from: 8, to: 8 } }
    ];

    var placeholder = $("#Annotations_chart");
